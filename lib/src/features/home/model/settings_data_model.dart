...
SettingsDataModel settingsDataModelFromJson(String str) => SettingsDataModel.fromJson(json.decode(str));
...
class SettingsDataModel {
  ...
  factory SettingsDataModel.fromJson(Map<String, dynamic> json) => SettingsDataModel(
    status: json["status"],
...
class Data {
  ...
  final String? promotionalSliderSubtitle2;
  ...
  final String? promotionalSliderBtnTitle2;
  final String? promotionalSliderBtnTitle3;
  final String? promotionalSliderBtnLink1;
  final String? promotionalSliderBtnLink2;
  final String? promotionalSliderBtnLink3;
  final bool? pointsEnabled;
  final String? googleAnalyticsId;
  final String? facebookPixels;
  final String? cardImgOrder;
  final String? cardImgReservation;
  final String? cardImgOffer;
  final String? cardImgPoints;
  final String? cardImgMyOrder;
  final String? redirectLinkOrder;
  final String? redirectLinkReservation;
  ...
  Data({
    ...
    this.facebookPixels,
    this.cardImgOrder,
    this.cardImgReservation,
    this.cardImgOffer,
    this.cardImgPoints,
    this.cardImgMyOrder,
    this.redirectLinkOrder,
    this.redirectLinkReservation,
  });
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    ...
    cardImgOrder: json["card_img_order"],
    cardImgReservation: json["card_img_reservation"],
    cardImgOffer: json["card_img_offer"],
    cardImgPoints: json["card_img_points"],
    cardImgMyOrder: json["card_img_my_order"],
    redirectLinkOrder: json["redirect_link_order"],
    redirectLinkReservation: json["redirect_link_reservation"],
  );
}
